@echo off
REM =============================================================================
REM HYDRA-UMC-DOCS-QA - build.bat
REM Copyright (C) 2026 JuanenRac (Electro Hobby 3D) <electrohobby3d@gmail.com>
REM GPL-3.0 - see LICENSE
REM =============================================================================
REM Builds HYDRA-UMC-DOCS-QA: creates/activates a venv, installs the
...
echo.
echo  ===============================================================
echo   H Y D R A - U M C - D O C S - Q A  -  build
echo  ===============================================================
echo   RAG-based technical assistant (Hailo-10)
...
python -m py_compile src\hydra_umc_docs_qa\__init__.py src\hydra_umc_docs_qa\main.py src\hydra_umc_docs_qa\ingest.py src\hydra_umc_docs_qa\index.py
if errorlevel 1 goto :error
python -c "import hydra_umc_docs_qa; print('import OK - version', hydra_umc_docs_qa.__version__)"
if errorlevel 1 goto :error
echo       Done.
echo.
